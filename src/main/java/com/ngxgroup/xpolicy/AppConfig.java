...
@ComponentScan(basePackages = {"com.ngxgroup.xpolicy"})
@EnableJpaRepositories(basePackages = {"com.ngxgroup.xpolicy.repository"})
...
//        super.addResourceHandlers(registry);
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.ngxgroup.xpolicy.model"});
